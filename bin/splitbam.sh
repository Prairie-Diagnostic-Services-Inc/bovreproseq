...
total_reads=$(samtools view -c $1_unfilt.bam)
...
sed -i "1i Amplicon_Name Size $1 Relative_Abundance" "$1_mappedreads.txt"
sed -i "1i Amplicon_Name Size $1 Relative_Abundance" "$1_full_length_mappedreads.txt"